...
(() => {
  ...
  #bfd-ring {
    ...
    border-radius: 50%; border: ${u(3)} solid #0ea5e9; opacity: 0; transform: scale(.3);
  }
  ...
  #bfd-sub {
    ...
    background: rgba(8, 30, 48, .94); color: #fff;
    ...
    box-shadow: 0 ${u(12)} ${u(40)} rgba(0,0,0,.35); border: 1px solid rgba(56,189,248,.35);
  }
  #bfd-sub.on { opacity: 1; transform: translateX(-50%) translateY(0); }
  #bfd-sub b { color: #7dd3fc; font-weight: 700; }

  #bfd-card {
    position: absolute; inset: 0; display: flex; flex-direction: column;
    align-items: center; justify-content: center; gap: ${u(22)};
    background: linear-gradient(150deg, #0c4a6e 0%, #0369a1 45%, #082f49 100%);
  ...
  #bfd-card .s { font-size: ${u(27)}; font-weight: 500; color: #bae6fd; max-width: ${u(760)}; line-height: 1.4; }
  #bfd-card .u { font-size: ${u(21)}; font-weight: 600; color: #38bdf8; letter-spacing: ${u(0.4)}; margin-top: ${u(6)}; }
  ...
  // documento esista: su un sito a piu' pagine e' l'unico modo per riaverlo a
  // ogni navigazione, ma qui <head> e <body> possono essere ancora nulli.
  // Quindi si attacca appena il documento e' pronto.
  const attach = () => {
